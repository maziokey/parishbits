...
INSTALLED_APPS = [
    ...
    # Local
    "cathedral.apps.CathedralConfig",
    "stkevins.apps.StkevinsConfig",
    # 3rd Party
    "django_hosts",
    "crispy_forms",
    "django_summernote",
...
ROOT_URLCONF = "config.urls.cathedral"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "cathedral.views.inject_form",  # my contact form context processor
            ],
        },
    },
]
